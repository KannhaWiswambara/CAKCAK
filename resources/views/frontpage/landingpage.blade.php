                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div class="flex items-baseline justify-between border-b border-gray200 pt-2 pb-6">
                            <h1 class="text-4xl font-bold tracking-tight text-gray900">EVENTS</h1>
                            {{-- <div class="flex items-center">
                                <div date-rangepicker class="flex items-center">
                                    <div class="relative">
                                        <div
                                            class="flex absolute inset-y-0 left-0 items-center pl3 pointer-events-none">
                                ...
                                <button type="button"
                                    class="inline-block mx-4 px-6 py-2 border2 border-blue-600 text-blue-600 font-medium text-xs leading-tight uppercase rounded-rmd hover:bg-indigo-100 hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration150 ease-in-out">Check</button>
                            </div> --}}
                        </div>
                        <section>
                                    ...
                                    <div class="flex space-x-4 mb-5 text-sm font-medium">
                                        <div class="flex-auto flex space-x-4">
                                            ...
                                            <button data-bs-toggle="modal" data-bstarget="#exampleModalLg"
                                                class="h-10 px-6 font-semibold rounded-full border border-slate200 text-slate-900"
                                                type="sumbit">
                                                Check Availability
                                            </button>
                                        </div>
